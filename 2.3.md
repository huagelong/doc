...
```
$this->whereEq("id", 1)->find();
//相当于 where id =1

$this->whereNeq("id", 1)->find();
//相当于 where id !=1

$this->where("id", ">", 1)->find();
//相当于 where id > 1

$this->whereIn("id", [1,2])->find();
//相当于 where id in (1,2)

$this->whereEq("id", 1)->whereEq("name", "trensy")->find();
...
$this->field("id")->table("t")->whereEq("id",1)->orderBy("id desc")->offset(0)->limit(10)->groupBy("name")->find();
//相当于 select id from t where id=1 order by id desc group by name limit 0, 10

$this->field("id")->table("t")->whereEq("id",1)->findOne()
//查询一条数据
